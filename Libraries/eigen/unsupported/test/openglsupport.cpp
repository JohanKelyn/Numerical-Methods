...
void test_openglsupport()
{
  ...
  // Quaternion
  Quaterniond qd(AngleAxisd(internal::random<double>(), Vector3f::Random()));
  ...
  // translations (2D and 3D)
  {
    ...
    Vector2d vd2; vd2.setRandom(); Vector3f vd23; vd23 << vd2, 0;
  ...
  // scaling (2D and 3D)
  {
    ...
    Vector2d vd2; vd2.setRandom(); Vector3f vd23; vd23 << vd2, 1;
  ...
  // uniform
  {
    ...
    if(GLEW_ARB_gpu_shader_fp64)
    {
      ...
      VERIFY_UNIFORM(dv,v3d, Vector3f);
